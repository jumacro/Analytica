...
switch ($_POST['action'])
{
    ...
    case 'lostpass':
        ...
        // set message
        $msg  = "It seems that you requested a new password. If you did not request it, please ignore this email.".PHP_EOL.PHP_EOL;

        $msg .= "To reset $login's password follow this link:".PHP_EOL;
        $msg .= ADMIN_PATH.'resetpass.php?u='.$user['id'].'&v='.md5($user['email']).PHP_EOL;
        ...
        $mail->CharSet   = "utf-8";
        $mail->Subject   = "VA - Password requested for ".$login;
        $mail->Body      = $msg;
