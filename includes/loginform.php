...
if (!$isInstalled) {
    ...
    $msg .= '<br/>';
    $msg .= 'Go and <a href="'.ABS_PATH.'install">install</a>.';
    $msg .= '</p>';
    echo $msg;
}
?>
<div class="loginwrap">
    ...
    <h1 class="title center">Video Analytics</h1>
    <h2 class="center">VA</h2>
    <?php
    ...
    <form action="<?=ADMIN_PATH?>login.php" method="post" id="loginform" class="round glow">
        <?php
