...
<head>
    ...
    <script type="text/javascript" src="<?=VA_AUX?>"></script>
...
<div id="global">
    ...
    <h1><strong>Video Analytics</strong> uninstaller</h1>
    ...
    if (isset($_POST['submit']))
    {
        ...
        if (isset($_POST['droptables'])) {
            ...
            foreach ($logs as $log) {
                if (is_file(CACHE_DIR.$log['file'])) {
                    unlink(CACHE_DIR.$log['file']);
                }
            }
    ...
    <?php if (isset($_POST['removejs'])) { ?>
        ...
        <script type="text/javascript">
            //<![CDATA[
            $(function(){
                // shorcut to Video Analytics aux functions
                var aux = va2fn;
    ...
    // Video Analytics is not installed
    ?>


        <h3 class="ko">Video Analytics is not installed</h3>
