...
if (isset($_POST['submit'])) {
    // load (va)2 system files
    require_once realpath(dirname(__FILE__).'/../').'/config.php';
    // process tracking data
    $_SESSION["va-trackingServer"] = !empty($_POST['trackingServer']) ? $_POST['trackingServer'] : url_get_server();
    $_SESSION["va-recTime"]        = $_POST['recTime'] > 0 ? $_POST['recTime'] : 3600;
    $_SESSION["va-fps"]            = $_POST['fps'] > 0 ? $_POST['fps'] : 24;
    $_SESSION["va-postInterval"]   = $_POST['postInterval'] > 0 ? $_POST['postInterval'] : 30;
    $_SESSION["va-cookieDays"]     = $_POST['cookieDays'] > 0 ? $_POST['cookieDays'] : 365;
    $_SESSION["va-layoutType"]     = !empty($_POST['layoutType']) ? $_POST['layoutType'] : "liquid";
    $_SESSION["va-contRecording"]  = isset($_POST['contRecording']) ? "true" : "false";
    $_SESSION["va-warn"]           = isset($_POST['warn']) ? "true" : "false";
    $_SESSION["va-disabled"]       = isset($_POST['disabled']) ? "true" : "false";
    // set code
