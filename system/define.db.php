...
/** Table for storing va records. */
define ('TBL_RECORDS',    "records");
/** Table for HV annotations. */
define ('TBL_HYPERNOTES', "hypernotes");
/** Table for caching HTML logs. */
define ('TBL_CACHE',      "cache");
/** Table for caching domains. */
define ('TBL_DOMAINS',    "domains");
...
/** Table for caching HTML pages. */
define ('TBL_SESSION',      "sessions");